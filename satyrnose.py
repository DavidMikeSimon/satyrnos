...
for i in range(runs):
	...
	app.objects.append(gameobj.GameObj((2.5, 2.5), geom=util.box_geom((1.5, 0.08))))
	...
	app.objects[1].drives.append(camera.DCameraLead(bounds=((5, 5), (11, 11))))
	app.objects[2].drives.append(image.DBlock(colors.purple, (1.5, 0.08)))
