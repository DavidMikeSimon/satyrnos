...
for i in range(runs):
	...
	app.objects[1].append(gameobj.GameObj(
		Point(1, 0.8), 
		geom=hull.load_hull("redball").make_geom(Size(0.75, 0.75), app.static_space),
		drives=[image.DImage("redball.png", Size(0.75, 0.75)), text.DDebugText("Hello nurse", colors.red)]))
	
	app.objects[1].append(gameobj.GameObj(
		Point(1, 2), 0.2,
		geom=hull.load_hull("redball").make_geom(Size(1.5, 1.5), app.static_space),
	...
	app.objects[1].append(gameobj.GameObj(
		Point(2.5, 9),
		geom=hull.load_hull("redball").make_geom(Size(0.375, 0.375), app.static_space),
	...
	#	geom=hull.load_hull("splat").make_geom(Size(1.5, 1.5)),
	...
	app.objects[3].append(gameobj.GameObj(
		Point(2.5, 1),
		body=sphere_body(1, 0.5),
		geom=hull.load_hull("ball").make_geom(Size(1, 1)),
